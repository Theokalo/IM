...
public class Searchview extends ListActivity implements OnClickListener {
	...
	public void updateJSONdata() {
		...
		JSONObject json = jsonParser.getJSONFromUrl(SEARCH_URL);
	...
	private void updateList() {
		...
		lv.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view,
				...
				SharedPreferences us = PreferenceManager.getDefaultSharedPreferences(Searchview.this);
				String username  = (String) ((TextView) view.findViewById(R.id.username)).getText();
				Editor edit = us.edit();
                edit.putString("user",username);
                edit.commit();
                Intent i = new Intent(Searchview.this,Tabprofile.class);
                finish();
                startActivity(i);
				//new add_req().execute();
			}
